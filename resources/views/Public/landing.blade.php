...
<head>
  ...
  <link href="{{ URL('assets/public/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ URL('assets/public/styles.css') }}" rel="stylesheet">
  <link href="{{ URL('assets/public/bootstrap.icons.css') }}" rel="stylesheet">
...
<body>
  ...
  <script src="{{ URL('assets/public/main.js') }}"></script>
